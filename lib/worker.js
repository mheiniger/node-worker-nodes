...
class Worker extends EventEmitter {
    constructor({ srcFilePath, maxTasks, maxMessageSize, endurance, stopTimeout, workerStopShift }) {
        super();
        ...
        const process = this.process = new WorkerProcess(srcFilePath, { maxMessageSize, stopTimeout });
