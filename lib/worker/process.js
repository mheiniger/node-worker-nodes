...
class WorkerProcess extends EventEmitter {
    constructor(modulePath, { maxMessageSize, stopTimeout, initMethod, initArgs }) {
        super();
        ...
        const transport = new Transport(child.stdio[3], maxMessageSize);
        ...
        child.send({ cmd: 'start', data: { modulePath, maxMessageSize, initMethod, initArgs } });
    }
