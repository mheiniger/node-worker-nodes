...
class WorkerNodesOptions {
    constructor({
        ...
        /**
         * If workerEndurance is used, all workers end at the same time
         * workerStopShift shifts the stop of a worker in the first iteration by the given number
         *
         *
         * @type {Number}
         * @default 0
         */
        this.workerStopShift = Number(workerStopShift);
